const organizationService = require("./organizationMembers.service");
...
const getMembersListOrganization = async (req, res, next) => {
  try {
    const organization = await organizationService.getMembersListOrganization(
      req.params.slug,
    );
